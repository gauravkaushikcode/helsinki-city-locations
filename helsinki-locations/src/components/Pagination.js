...
const Pagination = ({
  options: { limit = 10, page = 1, totalCount = 0 },
  onChange,
}) => {
  const totalPage =
      parseInt(totalCount / limit) + (parseInt(totalCount % limit) > 0),
    ...
    <tr>
      <td colSpan="5">
        ...
        <FontAwesomeIcon
          ...
          title="First"
          onClick={(e) => {
            !disablePrevious && onChange({ page: 1 });
          }}
        ></FontAwesomeIcon>
        <FontAwesomeIcon
        ...
        <FontAwesomeIcon
          ...
          onClick={(e) => {
            !disableNext && onChange({ page: totalPage });
          }}
        ></FontAwesomeIcon>
      </td>
    </tr>
